...
#' @export
sample_P_metropolis_trick_cpp_block <- function(P, Z, Sigma, sigma2, minibatch = TRUE, niter_metropolis = 50L, rho = 1.0, block_size = 1L) {
    .Call(`_latentcov_sbm_sample_P_metropolis_trick_cpp_block`, P, Z, Sigma, sigma2, minibatch, niter_metropolis, rho, block_size)
}
...
#'
#' @export
ilrInv_cpp <- function(z, basis, log = FALSE) {
